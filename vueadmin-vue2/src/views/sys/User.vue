<template>
    <div>
        <el-form :inline="true">
            ...
            <el-form-item>
                <el-button type="primary" @click="dialogVisible = true" v-if="hasAuth('sys:user:save')">新增</el-button><!--v-if="hasAuth('sys:user:save')"-->
            </el-form-item>
            <el-form-item>
                <el-popconfirm title="这是确定批量删除吗？" @confirm="delHandle(null)">
                    <el-button type="danger" slot="reference" :disabled="delBtlStatu" v-if="hasAuth('sys:user:delete')">批量删除</el-button><!--v-if="hasAuth('sys:user:delete')"-->
                </el-popconfirm>
            </el-form-item>
        </el-form>
        ...
        <el-table
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <el-avatar size="small" :src="'http://localhost:8081'+scope.row.avatar"></el-avatar>
                </template>
            </el-table-column>
